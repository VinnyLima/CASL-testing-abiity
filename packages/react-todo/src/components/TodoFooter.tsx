    ...
    return (
      <>
        <footer className="footer">
          ...
          <ul className="roles">
            <li className="help" title={hint}>
              Switch roles:
            </li>
            <li>
              <button
                type="button"
                className={this._selectedIfRole("admin")}
                onClick={this._setRole.bind(this, "admin")}
              >
                Admin
              </button>
            </li>
            <li>
              <button
                type="button"
                className={this._selectedIfRole("member")}
                onClick={this._setRole.bind(this, "member")}
              >
                Member
              </button>
            </li>
